    ...
    searchHotels: async ({ locationId, page = 0, size = 10, geo = null, zoom = null, filters = {} }) => {
        const body = {
            ...
            filters: {
                ...
                roomMaxAdult: filters.roomMaxAdult || null,
                roomMaxChildren: filters.roomMaxChildren || null,
                roomMaxExtraBed: filters.roomMaxExtraBed || null,
                roomPaxCapacity: filters.roomPaxCapacity || null,
                isRecommended: null,
                builtYear: null,
                renovationYear: null,
                roomCount: null,
