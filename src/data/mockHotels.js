export const mockHotels = [
    {
        ...
        featured: true,
        badges: [
            { type: 'featured', label: 'Editörün Seçimi', color: 'bg-primary/60' },
            { type: 'opportunity', label: 'Fırsat Oteli', color: 'bg-cyan-500/60' }
        ],
        description: "Experience the ultimate luxury at The Grand Azure Resort. Nestled on the cliffs of Oia, our resort offers breathtaking views of the Aegean Sea and the famous Santorini sunset. Our world-class amenities and impeccable service ensure an unforgettable stay.",
        images: [
    ...
    },
    {
        ...
        featured: false,
        badges: [
            { type: 'discount', label: 'Özel İndirim', color: 'bg-sky-500/60' }
        ],
        description: "Cave Paradise Suites offers a unique stay in traditionally carved cave rooms. Each suite is elegantly designed with modern touches and features a private balcony overlooking the caldera. Perfect for romantic getaways.",
        images: [
            'https://lh3.googleusercontent.com/aida-public/AB6AXuD_GD3EnzZWPUEBFRVwTFd97noc5eAUqCoMcW_ArMM5VEGrrnDNIwhLtwzX2dpXFFsfn0Lznmj-JVWPLmxROVHj2fLL_eMV5vDj1icvHh8LlBFrcfBjxT1HrsOQO3GrNnDYPoaUYrJabj5NpzaLUtneIsZHtX4tQDUaXB_hCbN8uIgGMU8QiCQAB0uo2xDy5U4iKR-c81o-uJYQldrN9cjPNZM172EfLVe_2MVPxRTWeG8kLJPU8cQdujgNbZDnsw2ceb9kbDIlnYEe'
        ],
        amenities: [
    ...
    },
    {
        ...
        featured: false,
        badges: [
            { type: 'popular', label: 'En Çok Tercih Edilen', color: 'bg-teal-500/50' }
        ],
        description: "Modern luxury meets traditional charm at Santo Pure Villas. Our spacious villas are designed for relaxation and comfort, making it the perfect base to explore the vibrant life of Fira.",
        images: [
            'https://lh3.googleusercontent.com/aida-public/AB6AXuBIbtNc7CL0z7WxBEfjFgYBey9dauaHvEuJpvVMtqPvIRkmdWzblqdPtXm3Y4kfbz-DWYKAeUldh6CoLduVaiHl0IJSo8RwnPW5fegbRcM8JJ6YGno9oOH7OMVQh9BNEGDjkSE6vssUX3cR4T55dWizsjotpjkqv_FoGrMdqulL9M3HV5ng8bMZZNpvY8mCyY7aUjonfvlHBcwiUKh9ZXEy9FK6B--8AjVh-Iwfy1-7ApR-_VGQKxDDUOEpPxnZ_El0p20wbGTBqf1P'
        ],
        amenities: [
    ...
    },
    {
        ...
        featured: false,
        badges: [
            { type: 'exclusive', label: 'Sadece Bizde', color: 'bg-[#137fec]/60' }
        ],
        description: "Astra Boutique Hotel offers a stylish and contemporary stay with one of the best infinity pools on the island. Enjoy breathtaking sunset views from our terrace bar.",
        images: [
