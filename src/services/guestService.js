...
export const guestService = {
    getSummary: async () => {
        return apiClient.get(`${API_BASE_URL}/agency-crm-guest/summary`);
    },
    filterGuests: async (data, page = 0, size = 10) => {
        return apiClient.post(`${API_BASE_URL}/agency-crm-guest/filter?page=${page}&size=${size}`, data);
    },
