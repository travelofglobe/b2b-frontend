                    ...
                    <div className="flex-1 overflow-hidden">
                        ...
                        <div className="h-full flex flex-col gap-6 overflow-hidden">
                            ...
                            <div className="flex-1 flex flex-col bg-white dark:bg-slate-900/50 backdrop-blur-3xl rounded-[40px] border border-slate-100 dark:border-white/5 overflow-hidden shadow-sm">
                                ...
                                <div className="flex-1 overflow-y-auto custom-scrollbar">
                                    <table className="w-full data-table">
                                        <thead><tr><th className="w-12 text-center"><input type="checkbox" className="rounded border-slate-300" /></th><th>Guest</th><th>Birth & Country</th><th>Passport</th><th>Contact</th><th>Status</th><th className="text-right">Actions</th></tr></thead>
                                        <tbody>
                                            {guestsLoading ? <TableSkeleton columns={7} /> : guests.length > 0 ? guests.map((g) => (
                                            ...
                                            )) : (<tr><td colSpan="7" className="py-20 text-center"><p className="text-slate-400 text-sm font-medium italic">No guests found</p></td></tr>)}
                                        </tbody>
                                    </table>
                                </div>
                            </div>
